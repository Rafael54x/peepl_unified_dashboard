...
export class PeeplDashboard extends Component {
    static props = {
        setViewCallback: { type: Function, optional: true }
    };
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            await this.loadData();
            if (this.props.setViewCallback) {
                this.props.setViewCallback(this.setView.bind(this));
            }
        });
...
PeeplDashboard.template = "peepl_unified_dashboard.WeeklyReportDashboard";

export { PeeplDashboard as WeeklyReportDashboard };
